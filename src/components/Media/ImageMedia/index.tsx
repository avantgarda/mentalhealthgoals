...
export const ImageMedia: React.FC<MediaProps> = (props) => {
  ...
  // Tells the browser how wide this image will actually be rendered, so it can
  // pick the right entry from the srcset. Every call site should pass `size`
  // describing its own slot — the 100vw default is the browser's own fallback
  // and over-fetches for anything narrower than the viewport.
